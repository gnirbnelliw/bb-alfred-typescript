...
!((t, e) => {
  ...
  const t = {
      ...
      parents(t, e) {
        const i = [];
        let n = t.parentNode;
        while (n && n.nodeType === Node.ELEMENT_NODE && 3 !== n.nodeType)
  ...
  var it = 'top',
    ...
    ot = 'left',
    rt = [it, nt, st, ot],
    at = rt.reduce((t, e) => t.concat([e + '-start', e + '-end']), []),
    lt = [].concat(rt, ['auto']).reduce((t, e) => t.concat([e, e + '-start', e + '-end']), []),
    ct = [
      'beforeRead',
      'read',
      'afterRead',
  ...
  function Wt(t) {
    return t.replace(/left|right|bottom|top/g, (t) => Bt[t]);
  }
  var qt = { start: 'end', end: 'start' };
  function zt(t) {
    return t.replace(/start|end/g, (t) => qt[t]);
  }
  function $t(t) {
    var e = dt(t);
        ...
        var n =
            'clippingParents' === e
              ? ((t) => {
                  ...
                  return ut(i) ? e.filter((t) => ut(t) && vt(t, i) && 'body' !== ht(t)) : [];
                })(t)
              : [].concat(e),
          s = [].concat(n, [i]),
          o = s[0],
  ...
  function Zt(t, e) {
    ...
    var i = e,
      ...
      c = void 0 === l ? lt : l,
      h = Yt(n),
      d = h ? (a ? at : at.filter((t) => Yt(t) === h)) : rt,
      u = d.filter((t) => c.indexOf(t) >= 0);
    0 === u.length && (u = d);
    var f = u.reduce(
      (e, i) => (
        (e[i] = Gt(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[gt(i)]), e
      ),
      {},
    );
    return Object.keys(f).sort((t, e) => f[t] - f[e]);
  }
  var Jt = {
    name: 'flip',
    enabled: !0,
    ...
    fn: (t) => {
      ...
      if (!e.modifiersData[n]._skip) {
        for (
          ...
          var N = Wt(I),
            j = [];
          if ((o && j.push(S[k] <= 0), a && j.push(S[I] <= 0, S[N] <= 0), j.every((t) => t))) {
            (T = C), (A = !1);
            break;
          }
          E.set(C, j);
        ...
        if (A)
          for (
            var M = (t) => {
                var e = v.find((e) => {
                  var i = E.get(e);
                  if (i) return i.slice(0, t).every((t) => t);
                });
  ...
  function ee(t) {
    return [it, st, nt, ot].some((e) => t[e] >= 0);
  }
  var ie = {
      name: 'hide',
      enabled: !0,
          ...
          setOptions: (i) => {
            ...
            var s,
              ...
              c = ((t) => {
                  ...
                  return (
                    ...
                    t.forEach((t) => {
                      i.has(t.name) ||
                        (function t(s) {
                          i.add(s.name),
                            [].concat(s.requires || [], s.requiresIfExists || []).forEach((n) => {
                              if (!i.has(n)) {
                                var s = e.get(n);
                                s && t(s);
                              }
                ...
                return ct.reduce((t, i) => t.concat(e.filter((t) => t.phase === i)), []);
              })(
                ...
                Object.keys(r).map((t) => r[t])),
              );
            return (
              (a.orderedModifiers = c.filter((t) => t.enabled)),
              ...
              if (le(e, i)) {
                (a.rects = {
                  ...
                  a.orderedModifiers.forEach(
                    (t) => (a.modifiersData[t.name] = Object.assign({}, t.data)),
                  );
  ...
  const pe = /ArrowUp|ArrowDown|Escape/,
